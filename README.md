# tf-atom-route-table-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-route-table-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-route-table-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform atom: AWS Route Table - creates a routing table for a VPC.
...
| Name | Description |
|------|-------------|
| <a name="output_arn"></a> [arn](#output\_arn) | ARN of the route table |
